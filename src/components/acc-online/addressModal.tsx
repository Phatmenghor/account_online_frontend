...
//         <div className="flex justify-end gap-3 px-8 py-6 bg-gray-50 rounded-b-2xl flex-shrink-0 border-t border-gray-200">
//           <Button
//             onClick={onClose}
...
// address validation in page.tsx
// Location Modal with Validation
"use client"
import { MapPin, X, Loader2 } from "lucide-react"
import type React from "react"
import { useState, useEffect } from "react"
