      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          <motion.div
            ...
            className="relative bg-white w-full sm:max-w-md rounded-t-lg sm:rounded-lg shadow-2xl overflow-hidden z-10 max-h-[90vh] flex flex-col"
          >
            ...
            <div className="px-5 pb-5 space-y-3 overflow-y-auto flex-1">
              ...
              {/* Score card */}
              <div className={`border rounded-lg p-3.5 ${scoreBg}`}>
                  ...
                  <div className="space-y-1.5">
                    {data.incorrectFields.map((field, index) => (
                      <motion.div
                        ...
                        className="flex items-center gap-2.5 bg-white border border-red-100 rounded px-3 py-2"
                      >
              ...
              <Button
                onClick={onClose}
                className="w-full bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white font-semibold py-2.5 rounded shadow-sm transition-all"
              >
                {translate("close")}
              </Button>
            </div>
