      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          <motion.div
            ...
            className="relative bg-white w-full sm:max-w-md rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden z-10 max-h-[90vh] flex flex-col"
          >
            {/* Red top accent bar */}
            ...
            <div className="px-5 pb-5 space-y-3 overflow-y-auto flex-1">
              ...
              {/* Score Card */}
              <div className={`border rounded-xl p-3.5 ${scoreBg}`}>
