...
export default function ModalLegalType({
    ...
    const [legalTypeDetail, setLegalTypeDetail] =
                        ...
                        <div className="flex-1">
                            ...
                            <DialogDescription className="text-base text-muted-foreground">
                                {isCreate
                                    ...
                                    : legalTypeDetail
                                        ? `Update information for "${legalTypeDetail.nameEn ||
                    ...
                    <div className="p-6 space-y-8">
                        ...
                        {isLoadingData ? (
                            ...
                            <div className="space-y-6">
                                            ...
                                            <Controller
                                                ...
                                                render={({ field }) => (
                                                    <Input
                                                        ...
                                                        disabled={isSubmitting}
                                                        className={`transition-colors ${errors.legalTypeValue ? "border-red-500" : ""
                                                            }`}
                                                    />
                                                )}
                                            />
                                ...
                                {/* Legal Type Info Card - Read Only (edit mode only) */}
                                {!isCreate && legalTypeDetail && (
                                    <div className="mt-2 p-4 bg-muted/30 rounded-lg border border-border">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 text-sm">
                                            <div>
                                                ...
                                                <p className="font-medium">{legalTypeDetail.id}</p>
                                            </div>
                                            <div>
                                                <span className="text-muted-foreground">
                                                    Current Status:
                                                ...
                                                <p className="font-medium">
                                                    {legalTypeDetail.status || "Unknown"}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
