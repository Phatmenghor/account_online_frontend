...
import { ChangePasswordReq } from "../types/user.types";
import { ChangePasswordService } from "../api/user.service";
...
export default function ChangePasswordForm({ value }: { value: string }) {
