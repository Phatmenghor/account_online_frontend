...
import { AllMaritalModel } from "@/models/static/marital/marital.response";
...
export async function getAllMaritalService(request: AllMaritalReq) {
    try {
        const response = await axiosClientWithAuth.post(
            "/api/v1/reference/marital-status/all",
            request
        );
...
export async function getMaritalByIdService(id: number) {
  try {
    const response = await axiosClientWithAuth.post(`/api/v1/reference/marital-status/get-by-id/${id}`);
    return response.data.data;
  } catch (error: any) {
    if (axios.isAxiosError(error)) {
      const raw = error.response?.data;
...
export async function createMaritalService(request: CreateMaritalReq) {
  try {
    const response = await axiosClientWithAuth.post("/api/v1/reference/marital-status/create", request);
    return response.data.data;
  } catch (error) {
    if (axios.isAxiosError(error)) {
      const raw = error.response?.data;
...
export async function updateMaritalService(
  ...
  try {
    const response = await axiosClientWithAuth.post(`/api/v1/reference/marital-status/update/${id}`, update);
    return response.data.data;
  } catch (error) {
    if (axios.isAxiosError(error)) {
      const raw = error.response?.data;
...
export async function deleteMaritalService(id: number) {
  try {
    const response = await axiosClientWithAuth.post(`/api/v1/reference/marital-status/delete/${id}`);
    return response.data.data;
  } catch (error) {
    if (axios.isAxiosError(error)) {
      const raw = error.response?.data;
